...
//        shareLinks.replaceAll(String::trim);
    ...
    private String searchContent(String key, String pg) {
        String searchURL = siteUrl + String.format("/page/%s?s=%s", pg, URLEncoder.encode(key));
