...
public class WPRBYQ extends Spider {
    ...
    public String detailContent(List<String> ids) throws Exception {
        ...
        String result = OkHttp.string(siteUrl + "/v1/disk/doc/" + ids.get(0) + "?from=web&with_meta=true", getHeaders());

        JSONObject object = new JSONObject(result);
        String link = object.getJSONObject("data").getString("link");
...
//        jsonObject.put("exclude_user", objects);
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                Vod vod = new Vod();
                vod.setVodId(item.getString("doc_id"));
                // 初始化备注为 "小米资源"
                String remarks = "未知";
...
//                }
                ...
                String shared_time = item.getString("shared_time");
                ...
                vod.setVodRemarks(remarks + "  " + shared_time);
                vod.setVodPic("");
                vod.setVodContent(files);
